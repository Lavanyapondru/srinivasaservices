                    ...
                    <div className="row mt-5 mb-5">
                        ...
                        <div className="col-lg-6 mt-5">
                           ...
                           <p className="para fs-5 lh-2 d-flex"><i class="bi bi-arrow-return-right text-warning me-3 fw-bold"></i> <a href="https://wa.me/919652735720" target='_blank' className="text-decoration-none text-dark">12 3456 7890</a> </p>
                            <p className="para fs-5 lh-2 d-flex"><i class="bi bi-envelope text-warning me-3"></i> <a href="mailto:srinivasacourierservices@gmail.com" className="text-decoration-none text-dark">srinivasacourierservices@gmail.com</a> </p>
                        </div>
                    </div>
                </div>
            </div>
